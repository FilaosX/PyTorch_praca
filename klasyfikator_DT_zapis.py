...
# Przykład użycia:
file_path = 'train_split_info/los3.pkl'
...
csv_file_path = 'meta_info/oceny_zdjec.csv'
...
#for value in image_train_values:
    #print(value)
train_data_folder = 'zdjecia_uczenie'
...
model.fit(X_train.reshape(-1, 512*512*3), y_train)
print('jestem5')
# Zapiszmy model do pliku
model_file_path = 'plik_decision_tree3.pkl'
save_model_to_file(model, model_file_path)
print('jestem6')
# Klasyfikacja na danych testowych
y_pred = model.predict(X_test.reshape(-1, 512*512*3))
print('jestem7')
